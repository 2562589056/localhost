			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="type.php" target="right">
							<li>分类管理</li>
						</a>
						<a href="inventory.php" target="right">
							<li>库存管理</li>
						</a>
						<a href="inbound.php" target="right">
							<li>入库管理</li>
						</a>
						<a href="warning.php" target="right">
							<li>预警信息设置</li>
						</a>
						<a href="outBoud.php" target="right">
							<li>出库管理</li>
						</a>
						<a href="user.php" target="right">
							<li>用户管理</li>
						</a>
						<a href="updatePwd.php" target="right"><li >修改密码</li></a>
					</ul>
				</li>
			</ul>
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="type.php" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
