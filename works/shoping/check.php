...
<?php
	...
	$id = $_GET['id'];
	//echo $id;
	$sql6 = "select * from discount where d_id = ".$id;
	...
	$sql1 = "select * from library where name = '".$arr6[0]['d_name']."' ";
...
<div class="sup-wid">
    ...
    <div class="pro_detail" >
        <div class="pro_detail_img float-lt">
            <div class="gallery">
                <div class="tb-booth tb-pic tb-s310"> <a href="images/<?php echo $arr6[0]['d_name']?>01_small.jpg"><img src="images/<?php echo $arr6[0]['d_name']?>01_small.jpg"  alt="展品细节展示放大镜特效" rel="images/<?php echo $arr6[0]['d_name']?>01_small.jpg" class="jqzoom" /></a> </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40"><a href="#" id='one'><img src="images/<?php echo $arr6[0]['d_name']?>01_small.jpg" mid="images/<?php echo $arr6[0]['d_name']?>01_small.jpg" big="images/<?php echo $arr6[0]['d_name']?>01_small.jpg"></a></div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40"><a href="#"><img  src="images/<?php echo $arr6[0]['d_name']?>02_small.jpg"  mid="images/<?php echo $arr6[0]['d_name']?>02_small.jpg" big="images/<?php echo $arr6[0]['d_name']?>02_small.jpg"></a></div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40"><a href="#"><img src="images/<?php echo $arr6[0]['d_name']?>03_small.jpg"  mid="images/<?php echo $arr6[0]['d_name']?>03_small.jpg" big="images/<?php echo $arr6[0]['d_name']?>03_small.jpg"></a></div>
                    </li>
                    <li style="margin-right:0px;">
                        <div class="tb-pic tb-s40"><a href="#"><img src="images/<?php echo $arr6[0]['d_name']?>04_small.jpg"  mid="images/<?php echo $arr6[0]['d_name']?>04_small.jpg" big="images/<?php echo $arr6[0]['d_name']?>04_small.jpg"></a></div>
                    </li>
                </ul>
            </div>
            <script type="text/javascript">
...
<!--
	function test()
	{
		 ...
		 var num = document.getElementById("num");//num.value
		 var name = $('#d_name').html();//name
		 var img = $('#one img').attr('src');
		 var money = $('#money').html();
		 var money2 = money.substring(1,10);
		 location.href="pay1.php?"+"num="+encodeURI(num.value)+"&name="+name+"&img="+img+"&money2="+money2+"&id="+id.value;
	}
	 /*$('#aa').click()
	 {
		 alert('13');
...
<meta charset='utf-8'>
        ...
        <div class="float-lt pro_detail_con">
            <div class="pro_detail_tit" id='d_name'><?php echo $arr6[0]['d_name']?></div>
            <div class="pro_detail_ad"><?php echo $arr6[0]['d_notes']?></div>
            ...
            <div class="clear"></div>
			<input type='hidden' value='<?php echo $arr6[0]['d_id']?>' id='d_id'>
            <div class="pro_detail_price  margin-t20"><span class="margin-r20">市场价</span><span style=" font-size:16px"><s>￥<?php echo $arr6[0]['d_money_t']?></s></span></div>
            <div class="clear"></div>
            <div class="pro_detail_act margin-t20 fl"><span class="margin-r20">售价</span><span style="font-size:26px; font-weight:bold; color:#dd514c;" id='money'>￥<?php echo $arr6[0]['d_money_o']?></span></div>
            <div class="clear"></div>
            ...
            <div class="pro_detail_number margin-t30">
                ...
                <div class=""> <i class="jian"></i>
                    <input type="text" value="1" id='num' class="float-lt choose_input"/>
                    <i class="jia"></i> <span>&nbsp;</span> <span>（库存<?php echo $arr1[0]['quantity']?>）</span> </div>
                <div class="clear"></div>
            </div>
            <div class="guige">
                <div class="margin-r20 float-lt" style="line-height:25px;">规格</div>
                <ul>
                    <li class="guige-cur">标准规格</li>
            ...
            <div class="pro_detail_btn margin-t30">
                <ul>
                    <li class="pro_detail_shop"><a href="#" id='aa' onclick='test()'>立即购买</a></li>
                    <li class="pro_detail_add"><a href="shopping_car1.php?id=<?php echo $id?>" onclick="ShowDiv('MyDiv','fade')">加入购物车</a></li>
                </ul>
            </div>
        </div>
		</form>
